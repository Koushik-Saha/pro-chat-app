...
public class MainActivity extends AppCompatActivity {
    ...
    static final String APP_ID = "75408";
    static final String AUTH_KEY = "6EZHUw-25ZXvUbg";
    static final String AUTH_SECRET = "7V8Cwj7unPAPEy-";
    static final String ACCOUNT_KEY = "WzyC33awXzAYnkQAobVi";
